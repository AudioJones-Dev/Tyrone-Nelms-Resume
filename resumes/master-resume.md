...
**Founder / Operations & Digital Marketing Specialist / AI Operations Consultant**  
April 2020 – Present

- Provide strategic consultation and operational management for clients across digital marketing, business operations, and workflow improvement.
- Manage client projects across tools including ClickUp, Asana, Notion, Google Workspace, and Microsoft 365.
- Lead content creation, brand strategy, advertising support, and campaign execution to improve brand visibility and customer engagement.
- Design AI-supported workflows, operational documentation, and business systems for founder-led service businesses.
- Translate business problems into practical systems, processes, automations, and implementation plans.
...
- Support event planning and client-facing creative production.
- Operate photo booth services and provide photography and videography.
- Coordinate on-site execution for customer events and media deliverables.
...
- Delivered positive customer experiences by applying quality assurance practices.
- Handled difficult calls with professionalism and strong telephone etiquette.
...
- Supported first-call resolution and accurate documentation of contracts, caller issues, fire code occupancies, required steps, and final resolution.
- Provided training, mentoring, coaching, new-hire floor support, and team huddle updates.
- Assisted with supervisor callbacks, escalations, and special cases requiring immediate attention.
- Recognized as Employee of the Month, quarterly top performer, TPSM Team SME, and team lead.
- Achieved perfect attendance for two years and maintained over 99% adherence every month per metrics.
