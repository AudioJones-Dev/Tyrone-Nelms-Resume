...
- **Title:** Founder / AI Operations Consultant
- **Dates:** April 2020 – Present
- **Location:** Miami, Florida (remote / client sites)
...
- **Title:** Independent Contractor — ADA & Mobile Lift Technician / Marketing & Operations
- **Dates:** July 2023 – Present
- **Location:** Florida

Description:

> Field operations and marketing/operations support for an accessibility-services business: technical support and maintenance for ADA and mobile lift equipment, logistics coordination, customer communication, safety standards, and operational process improvements.

## Miami Spin 360

- **Title:** Event Planner / Creative Operations
...
> Inbound provider support: answering questions and payment-option calls, researching customer and provider issues to develop resolutions, applying quality assurance practices, and handling difficult calls professionally.
...
> Senior commercial-account support: issue resolution across Salesforce, RightNow, SharePoint, and internal systems; end-to-end documentation; first-call resolution focus; escalations and supervisor callbacks.
>
> Recognized as Employee of the Month (March 2015), quarterly top performer, TPSM Team SME, and team lead; two years perfect attendance; 99%+ monthly adherence. Trained and mentored team members and supported new hires on the floor.
