...
LinkedIn headline (220-character limit). Derives from the Title System in [`docs/professional-brand.md`](../docs/professional-brand.md) — maximum two stacked title elements, plus a value clause.
