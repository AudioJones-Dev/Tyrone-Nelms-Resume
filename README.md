...
- `docs/public-surfaces.md` — registry of live public web properties (tyronenelms.com, audiojones.com, LinkedIn, GitHub), their audience boundaries, and the claim rules governing each.
